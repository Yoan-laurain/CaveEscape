package com.CaveEscape.myapplication.MainMenu;
...
import com.CaveEscape.myapplication.Dao.HistoryDAO;
...
import com.CaveEscape.myapplication.Lib.Security;
...
public class LoadingActivity extends AppCompatActivity
{
    ...
    public final static String CONNEXION_API = "http://api.sudododevelopers.xyz:8383/api.php";   // API PROD
